...
2. Download the latest JARs from [Releases](https://github.com/jaebong-human/minecast/releases/latest) and place them in your server's `mods/` folder:
...
2. Download the latest JARs from [Releases](https://github.com/jaebong-human/minecast/releases/latest) and place them in your `mods/` folder:
